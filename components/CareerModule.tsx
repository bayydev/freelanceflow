        ...
        <div className="flex flex-1 overflow-hidden relative">
            ...
            `}>
                ...
                {CAREER_CONTENT.map((module, idx) => {
                    ...
                    // Logic for Sequential Unlocking (Pro Users)
                    ...
                    const isLockedBySequence = isPremium && idx > 0 && !isPreviousCompleted;
                    
                    const isDisabled = isLockedBySequence; 
                    ...
                    return (
                        <button 
                            ...
                            className={`w-full p-4 flex items-center justify-between text-left transition-all rounded-xl border ${
                                isActive 
            ...
            <div 
                ...
                ${activeModuleId ? 'flex w-full absolute inset-0 md:static' : 'hidden md:flex'}
            `}>
                {activeModuleId ? (
                    (() => {
                            ...
                            return (
                                <div className="flex flex-col items-center justify-center h-full text-center animate-fade-in p-8">
                                    ...
                                    <p className="text-slate-400 max-w-md mb-8 leading-relaxed text-sm sm:text-base">
                                        Você completou o Módulo 1 e deu o primeiro passo. Mas a estratégia completa de vendas, negociação e escala está bloqueada.
                                        <br/><br/>
                                        <span className="text-white font-bold">Desbloqueie agora os 8 módulos avançados</span> e pare de perder clientes.
                                    </p>
                            ...
                            <div className="max-w-3xl mx-auto w-full animate-fade-in pb-10">
                                ...
                                <div className="mt-12 pt-8 border-t border-slate-800">
                                    <button 
                                        ...
                                        className={`w-full py-4 rounded-xl font-black text-lg uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-lg ${
